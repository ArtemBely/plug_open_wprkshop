		...
		<div className='container'>
			<div className='wrap_information'>
				...
				<div className='information_block1'>
					...
					<p className='block1_more information_more'>More</p>
				</div>
				...
				<div className='information_block2'>
					...
					<p className='block2_more information_more'>More</p>
				</div>
				...
				<div className='information_block3'>
					...
					<p className='block3_more information_more'>More</p>
				</div>
				...
				<div className='information_block4'>
					...
					<p className='block4_more information_more'>More</p>
				</div>
